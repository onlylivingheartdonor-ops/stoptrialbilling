      ...
      <main className="stb-wrap">
        ...
        <div className="stb-card">
          ...
          <div className="stb-search-box">
            ...
            <input className="stb-search-input" type="text" placeholder="Netflix, Spotify, Amazon..." value={search} onChange={e => setSearch(e.target.value)} />
          </div>
        ...
        <div className="stb-card">
          ...
          <div className="stb-info-grid">
            <div className="stb-info-item"><p className="stb-info-title">40% forget to cancel</p><p className="stb-info-body">Studies show over 40% of free trial users forget and get charged.</p></div>
            <div className="stb-info-item"><p className="stb-info-title">Subscription inertia</p><p className="stb-info-body">Companies rely on the hassle of canceling to keep you paying.</p></div>
            <div className="stb-info-item"><p className="stb-info-title">Cancel anytime</p><p className="stb-info-body">The FTC's "Click to Cancel" rule makes cancellation as easy as sign-up.</p></div>
            <div className="stb-info-item"><p className="stb-info-title">Use virtual cards</p><p className="stb-info-body">Privacy.com lets you set one-time-use card numbers.</p></div>
          </div>
        </div>

        <div className="stb-card">
          <p className="stb-section-title">Pro tips</p>
          <div className="stb-tip-grid">
            <div><p className="stb-tip-num">01</p><p className="stb-tip-title">Cancel immediately</p><p className="stb-tip-body">Sign up, then cancel within 5 minutes. You still get the full trial.</p></div>
            <div><p className="stb-tip-num">02</p><p className="stb-tip-title">Set calendar reminders</p><p className="stb-tip-body">Add a reminder 48 hours before the trial ends.</p></div>
            <div><p className="stb-tip-num">03</p><p className="stb-tip-title">Check bank statements</p><p className="stb-tip-body">Review credit card statements monthly for hidden charges.</p></div>
            <div><p className="stb-tip-num">04</p><p className="stb-tip-title">Use subscription trackers</p><p className="stb-tip-body">Apps like Rocket Money track all recurring bills.</p></div>
          </div>
          <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "FAQPage", mainEntity: [{ "@type": "Question", name: "Can I cancel a free trial immediately?", acceptedAnswer: { "@type": "Answer", text: "Yes. Most services allow immediate cancellation and still honor the full trial period." } }, { "@type": "Question", name: "What happens if I forget to cancel?", acceptedAnswer: { "@type": "Answer", text: "You will be automatically charged, typically for a full month or year of service." } }] }) }} />
        </div>

        <div className="stb-card">
          <p className="stb-section-title">Related tools</p>
          <div className="stb-related-links">{RELATED.map((r, i) => (<a key={i} className="stb-related-link" href={r.href}>{r.label}</a>))}</div>
          <div className="stb-disclaimer">This site provides direct links to third-party cancellation pages. We are not affiliated with any service listed.<div className="stb-footer-links"><a href="/privacy">Privacy Policy</a><a href="/terms">Terms of Service</a></div></div>
        </div>
      </main>
    </>
  );
